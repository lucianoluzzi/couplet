...
import com.couplesdating.couplet.databinding.FragmentAcceptedInviteBinding
import com.couplesdating.couplet.ui.extensions.setColor
import com.couplesdating.couplet.ui.extensions.setFont
import com.couplesdating.couplet.ui.extensions.textValue

class AcceptedInviteFragment : Fragment() {
    private val binding by lazy {
        val layoutInflater = LayoutInflater.from(requireContext())
        FragmentAcceptedInviteBinding.inflate(layoutInflater)
    }
    private val navigationArgs by navArgs<AcceptedInviteFragmentArgs>()
    ...
    private fun decorateTitle() = with(binding) {
        user.firstName?.let {
            ...
            val currentUser = it
            title.text = getString(R.string.accepted_invite_title, currentUser, inviter)
